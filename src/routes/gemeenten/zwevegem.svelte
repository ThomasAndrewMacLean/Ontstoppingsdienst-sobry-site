...
<svelte:head>
    <title>Ontstoppingsdienst Sobry |  Zwevegem | 0467/00.50.50</title>
    <meta
        name="description"
        content="Ontstoppingsdienst Sobry.  Zwevegem Vakkundig en Proper opgelost! 24/7 bereikbaar. Jarenlange Ervaring.
        Totaaloplossingen. Transparante prijs." />
    <meta name="keywords" content="Ontstoppingsdienst Sobry, Over mij" />
</svelte:head>
<Hero {labels} />
<h1>Ontstopper nodig in  Zwevegem? Ontstoppingsdienst Sobry!</h1>
<ul>
    <li>
