...
<svelte:head>
    <title>Ontstoppingsdienst Sobry |  Petegem-aan-de-leie | 0467/00.50.50</title>
    <meta
        name="description"
        content="Ontstoppingsdienst Sobry.  Petegem-aan-de-leie Vakkundig en Proper opgelost! 24/7 bereikbaar. Jarenlange Ervaring.
        Totaaloplossingen. Transparante prijs." />
    <meta name="keywords" content="Ontstoppingsdienst Sobry, Over mij" />
</svelte:head>
<Hero {labels} />
<h1>Ontstopper nodig in  Petegem-aan-de-leie? Ontstoppingsdienst Sobry!</h1>
<ul>
    <li>
