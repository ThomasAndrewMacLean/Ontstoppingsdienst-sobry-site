...
<svelte:head>
    <title>Ontstoppingsdienst Sobry |  Oostende | 0467/00.50.50</title>
    <meta
        name="description"
        content="Ontstoppingsdienst Sobry.  Oostende Vakkundig en Proper opgelost! 24/7 bereikbaar. Jarenlange Ervaring.
        Totaaloplossingen. Transparante prijs." />
    <meta name="keywords" content="Ontstoppingsdienst Sobry, Over mij" />
</svelte:head>
<Hero {labels} />
<h1>Ontstopper nodig in  Oostende? Ontstoppingsdienst Sobry!</h1>
<ul>
    <li>
